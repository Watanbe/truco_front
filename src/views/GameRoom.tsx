...
export default function gameRoom() {
	...
	const resetTableOrder = () => {
		if (player && player.name && roundOrder) {
	...
	return (
		<div className="min-h-screen game-room-background text-white/90 md:grid md:grid-cols-5 md:content-normal md:gap-4">
						...
						<div className="m-0 grid h-full grid-rows-6 gap-2 p-0 ">
							...
							<div className="row-span-3">
								<div className="grid h-full grid-cols-8 gap-2">
									...
									<div className="col-span-4 grid h-full grid-cols-3 rounded-full table-background">
										<div className="col-span-1 flex items-center justify-center">
											{/* LEFT */}
											{tableOrder.length > PLAYER_POSITION_LEFT && (
												<img
			...
			<button
				id="toggleChatButton"
				className="rounded-md absolute bottom-3 right-3 flex rounded-full bg-green-400 p-3 text-gray-50 shadow-sm focus-within:bg-green-700 focus-within:outline hover:bg-green-600 disabled:bg-blue-300 md:hidden"
				type="button"
				onClick={toggleChat}
			>
				<Icon>chat</Icon>
